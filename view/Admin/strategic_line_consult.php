...
<body>
	...
	<div class="container">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php print $row['STRATEGIC_LINE_STATUS'];?></td>
		...
		<div class="row-fluid">
                    <a href="http://localhost/SIE_V2/view/strategic_lines.php?id=<?php //print $reg['DOCUMENT_NUMBER'];?>" class="btn btn-primary "><img alt="Prev" src="../img/glyphicons/glyphicons_036_file.png" height="20" width="20"> <strong>Nueva Linea</strong></a>
		</div>
		<!--% }%-->
	</div>
