	...
	Vanadium
			.addValidatorTypes( [
					...
					[
							...
							function(a, b) {
								return '<small>&nbsp&nbsp&nbsp  <img src="../../img/glyphicons/glyphicons_207_remove_2.png" height="15" width="15">  El valor ingresado debe tener como máximo <span class="'
										+ Vanadium.config.message_value_class
										+ '">'
										+ b
										+ "</span> caracteres."
