<?php
    ...
    $save_sl->setConsulta("INSERT INTO `sie`.`strategics_lines` (`STRATEGIC_LINE_NAME`, `STRATEGIC_LINE_STAR_DATE`, `STRATEGIC_LINE_STATUS`, `DESCRIPTION`)
        VALUES ('$name_sl', '$start_date_sl', $status_sl, '$description_sl')");
